...
class AlmacenGeneralController extends Controller
{
    ...
    public function data(){
        ...
        ->select('producto.nombre','producto.capacidad','producto.unidad_medida','producto.clave_sat','almacen.inicial','producto.precio_compra','producto.precio_venta','producto.precio_minimo',
            DB::raw('
