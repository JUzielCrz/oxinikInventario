        ...
        <div class="card-header">
            <div class="row">
                <div class="col-md-4 form-group">
                    ...
                    <input type="text" name="provedor" id="provedor" value="{{$proveedor}}" class="form-control form-control-sm" placeholder="Nombre">
                    <div id="listar-provedores"></div>
                </div>
                <div class="col-md-2 form-group">
                    <label for="">Tipo Folio</label>
                    <select name="tipo_folio" id=""  class="form-control form-control-sm">
                        <option value="{{$nota->tipo_folio}}" disabled>{{$nota->tipo_folio}}</option>
                ...
                <div class="col-md-2 form-group">
                    ...
                    <input type="text" name="folio" id="folio" value="{{$nota->folio}}" class="form-control form-control-sm" placeholder="Folio">
                </div>
                <div class="col-md-3 form-group">
                    <label for="">Fecha</label>
                    <input type="date" name="fecha" id="fecha" value="{{$nota->fecha}}" class="form-control form-control-sm" >
                </div>
